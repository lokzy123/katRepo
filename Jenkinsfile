        ...
        stage('Get PR for Branch') {
            steps {
                script {
                    ...
                    def response = httpRequest url: prApiUrl, customHeaders: [[name: 'Authorization', value: 'Bearer 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']], acceptType: 'APPLICATION_JSON'
