        ...
        stage('Get PR for Branch') {
            steps {
                script {
                    ...
                    def response = httpRequest url: prApiUrl, customHeaders: [[name: 'Authorization', value: 'token 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']], acceptType: 'APPLICATION_JSON'
